...
import {
    AwsSolutionsLibrarySampleAddressValidationStack
} from "../lib/aws_solutions_library_sample_address_validation_stack";

const app = new cdk.App();
const stack = new AwsSolutionsLibrarySampleNormalizationLibraryStack(app, 'EntityResolutionNormalizationStack', {
...
const addressStack = new AwsSolutionsLibrarySampleAddressValidationStack(app, 'EntityResolutionAddressValidationStack', {
    description: 'Guide for Address Validation and Normalization with AWS Entity Resolution'
    /* Uncomment the next line to specialize this stack for the AWS Account
   * and Region that are implied by the current CLI configuration. */
    // env: { account: process.env.CDK_DEFAULT_ACCOUNT, region: process.env.CDK_DEFAULT_REGION },
